...
with open('../verkefni4-out/index.html', 'w', encoding='utf-8') as file:
    file.write(index_html)

with open('../verkefni4-out/bread.html', 'w') as file:
...
for post in POSTS:
    ...
    post_file_path = '../verkefni4-out/posts/{slug}.html'.format(slug=post_metadata['slug'])
